...
func _on_mago_de_fogo_pressed() -> void:
	selecionar_personagem( "mago_de_fogo", preload("res://assets/Personagens/mago_de_fogo.png"))


func _on_mago_de_agua_pressed() -> void:
		selecionar_personagem( "mago_da_agua", preload("res://assets/Personagens/mago_de_agua.png"))


func _on_mago_da_natureza_pressed() -> void:
		selecionar_personagem( "mago_da_Natureza", preload("res://assets/Personagens/mago_da_floresta.png"))
